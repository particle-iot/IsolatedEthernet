...
const unsigned char DEC = 10; //!< Decimal (base 10)
const unsigned char HEX = 16; //!< Hexadecial (base 16)
const unsigned char OCT = 8;  //!< Octal (base 8)
const unsigned char BIN = 2;  //!< Binary (base 2)
